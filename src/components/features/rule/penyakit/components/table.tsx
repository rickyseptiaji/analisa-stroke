...
import { rulePenyakitColumns } from "./columns";
...
export function RulePenyakitTable({ data, isLoading }: TableState) {
  ...
  const handleAdd = () => {
    router.push("/rule/penyakit/create");
  };
      ...
      <div className="flex items-center justify-between px-4 lg:px-6">
        <div className="flex items-center gap-2">
          <Button variant="outline" size="sm" onClick={handleAdd}>
            <IconPlus />
            <span className="hidden lg:inline">Add Aturan</span>
          </Button>
        </div>
      </div>
            ...
            <Table>
              ...
              <TableBody>
                {table.getRowModel().rows?.length ? (
                  ...
                  <TableRow>
                    <TableCell
                      colSpan={rulePenyakitColumns.length}
